...
-- Constraint: AccesstoCleanFuelsAndTechnologiesForCooking_pkey
-- ALTER TABLE IF EXISTS public."AccesstoCleanFuelsAndTechnologiesForCooking" DROP CONSTRAINT IF EXISTS "AccesstoCleanFuelsAndTechnologiesForCooking_pkey";
ALTER TABLE IF EXISTS public."AccesstoCleanFuelsAndTechnologiesForCooking"
    ADD CONSTRAINT "AccesstoCleanFuelsAndTechnologiesForCooking_pkey" PRIMARY KEY ("Id_Access-to-clean-fuels-and-technologies");
...
-- Constraint: ShareOfThePopulationWithAccessToElectricity_pkey
-- ALTER TABLE IF EXISTS public."ShareOfThePopulationWithAccessToElectricity" DROP CONSTRAINT IF EXISTS "ShareOfThePopulationWithAccessToElectricity_pkey";
ALTER TABLE IF EXISTS public."ShareOfThePopulationWithAccessToElectricity"
    ADD CONSTRAINT "ShareOfThePopulationWithAccessToElectricity_pkey" PRIMARY KEY ("Id_share-of-the-population-with-access-to-electricity");
...
-- ALTER TABLE IF EXISTS public."AccesstoCleanFuelsAndTechnologiesForCooking" DROP CONSTRAINT IF EXISTS "Entity";
ALTER TABLE IF EXISTS public."AccesstoCleanFuelsAndTechnologiesForCooking"
...
-- Constraint: Entity
-- ALTER TABLE IF EXISTS public."ShareOfThePopulationWithAccessToElectricity" DROP CONSTRAINT IF EXISTS "Entity";
ALTER TABLE IF EXISTS public."ShareOfThePopulationWithAccessToElectricity"
    ADD CONSTRAINT "Entity" FOREIGN KEY ("Id_Entity")
    REFERENCES public."Entidades" ("Id_Entity") MATCH SIMPLE
    ON UPDATE NO ACTION
...
CREATE INDEX IF NOT EXISTS "fki_Entity"
    ON public."AccesstoCleanFuelsAndTechnologiesForCooking" USING btree
...
CREATE INDEX IF NOT EXISTS "fki_Entity"
    ON public."ShareOfThePopulationWithAccessToElectricity" USING btree
    ("Id_Entity" ASC NULLS LAST)
    TABLESPACE pg_default;
